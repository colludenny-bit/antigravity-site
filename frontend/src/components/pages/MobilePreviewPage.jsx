            ...
            `,
                        ...
                        <div style={{
                            ...
                            <div style={{
                                ...
                                left: 0,
                                right: 0,
                                height: 44 * SCALE_FOR_SCREEN,
                                zIndex: 5,
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'space-between',
                                padding: `0 ${20 * SCALE_FOR_SCREEN}px`,
                                background: 'rgba(0,0,0,0.3)',
                                backdropFilter: 'blur(10px)',
                            }}>
                                <span style={{ color: '#fff', fontSize: 10 * SCALE_FOR_SCREEN, fontWeight: 600 }}>
                                    {new Date().toLocaleTimeString('it-IT', { hour: '2-digit', minute: '2-digit' })}
                                </span>
                                <div style={{ display: 'flex', gap: 3, alignItems: 'center' }}>
                                    <span style={{ color: '#fff', fontSize: 8 * SCALE_FOR_SCREEN }}>5G</span>
                                    <span style={{ color: '#fff', fontSize: 8 * SCALE_FOR_SCREEN }}>📶</span>
                                    <span style={{ color: '#fff', fontSize: 8 * SCALE_FOR_SCREEN }}>🔋</span>
                                </div>
                            </div>
